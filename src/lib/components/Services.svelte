  ...
  const services = [
    {
      ...
      description:
        "Khám phá thị trường xa xỉ thông qua các chuyên gia đại lý của chúng tôi. Chúng tôi sẽ đàm phán quyết liệt để đảm bảo bạn tìm được bất động sản hoàn hảo với chi phí tối ưu.",
      icon: "key",
    },
    {
      title: "Dịch Vụ Bán Hàng",
      description:
        "Chiến lược tiếp thị độc quyền đưa bất động sản của bạn tiếp cận mạng lưới người mua có giá trị ròng cao trên toàn cầu. Chúng tôi xử lý mọi chi tiết từ dàn cảnh đến lúc chốt tỷ lệ.",
      icon: "home",
    },
    {
      title: "Danh Mục Ưu Tiên",
      description:
        "Tiếp cận hồ sơ và danh mục các bất động sản không công khai. Chúng tôi tôn trọng quyền riêng tư và đảm bảo mang lại những giao dịch kín đáo cho những ngôi nhà siêu sang.",
      icon: "lock",
    },
  ];
</script>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
      {#each services as service}
        ...
        >
          ...
          <p
            class="text-[1.05rem] text-text-secondary leading-relaxed mb-8 flex-grow"
          >
            {service.description}
          </p>
          <a
