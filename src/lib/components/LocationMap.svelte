...
<section class="py-32 bg-bg-color relative overflow-hidden">
  ...
  <div class="max-w-7xl mx-auto px-6 md:px-8 grid grid-cols-1 lg:grid-cols-[1fr_1.15fr] gap-14 items-center relative z-10">
    ...
    <div class="h-[450px] lg:h-[600px] gsap-reveal relative" use:fadeUp={{ x: 40, y: 0, delay: 0.2 }}>
      <div class="w-full h-full rounded-[1.5rem] relative overflow-hidden p-3 md:p-4 border border-border-color bg-white/70 dark:bg-slate-900/75 backdrop-blur-md shadow-[0_30px_60px_rgba(0,0,0,0.05)]">
        ...
        <!-- Marker -->
        <div class="absolute bg-white dark:bg-slate-800 border-[3px] border-accent w-[64px] h-[64px] rounded-full flex items-center justify-center shadow-xl text-3xl font-black text-accent top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
